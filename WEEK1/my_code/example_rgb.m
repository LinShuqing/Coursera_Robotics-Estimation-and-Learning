...
%  在RGB色彩空间中的利用3D高斯模型进行识别
rgb_mu=mean(Samples);
[number,dim]=size(Samples);
% 计算sigma的临时变量
sig_temp=double(Samples) - rgb_mu;
rgb_sigma=sig_temp'*sig_temp/number;

save("rgb_mu.mat",'rgb_mu');
save("rgb_sigma.mat",'rgb_sigma');
